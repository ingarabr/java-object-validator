...
import com.github.inarabr.conditions.ExistsCondition;
...
public class AndValidationTest {
  ...
  public void shouldBeValidWhenAllValidationsEvaluatesSuccessfully() throws Exception {
    AndValidation and = AndValidation.and(
        validation(field(SomeBean.class).getValue(), ExistsCondition.mustHaveValue()),
        validation(field(SomeBean.class).getAnotherBean(), ExistsCondition.mustHaveValue())
    );
